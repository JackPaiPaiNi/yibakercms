 ...
 * File name:AlipayOrderDao.java   Package name:com.xinlianfeng.yibaker.provider.dao
...
public interface AlipayOrderDao
{
	...
	int createAlipayOrder(AlipayOrder alipayOrder);
	
	int updateAlipayOrderSign(AlipayOrder alipayOrder);
	
	AlipayOrder findOneByOrderno(@Param("out_trade_no") String orderno);
}
